...
(function () {
    ...
    window.UEDITOR_CONFIG = {
		...
		, toolbars: [[
            ...
            'insertimage','link', 'unlink', 'anchor', '|','horizontal', 'date', 'time'],[
            'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', 'charts', '|','customselect','customcontrol',
            'print'
        ]]
