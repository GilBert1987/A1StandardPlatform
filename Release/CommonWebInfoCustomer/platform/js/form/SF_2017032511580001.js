...
function fn_deptuser(deptid){
	...
	sqlInfo="SELECT DISTINCT sc_post_org.id,CONCAT(sc_organization.name,'-',sc_post.name)AS deptpostname FROM sc_post_org JOIN sc_organization ON sc_post_org.org_id=sc_organization.id JOIN sc_post ON sc_post_org.post_id=sc_post.id WHERE sc_organization.id='"+deptid+"'";
...
function fn_selList(list){
	...
	$(list).each(function(index, ele) {
         option='<option value="'+ele.id+'">'+ele.deptpostname+'</option>';
