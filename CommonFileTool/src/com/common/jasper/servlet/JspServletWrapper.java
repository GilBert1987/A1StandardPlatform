...
import com.common.jasper.compiler.ErrorDispatcher;
import com.common.jasper.compiler.JavacErrorDetail;
...
public class JspServletWrapper {
    ...
    private Long JspContentLastModified;
    private StringBuilder jspContent = null;

    public String getSourceEnc() {
		return sourceEnc;
	}

	public void setSourceEnc(String sourceEnc) {
		this.sourceEnc = sourceEnc;
	}

	public Long getJspContentLastModified() {
		return JspContentLastModified;
	}

	public void setJspContentLastModified(Long jspContentLastModified) {
		JspContentLastModified = jspContentLastModified;
	}

	public StringBuilder getJspContent() {
		return jspContent;
	}

	public void setJspContent(StringBuilder jspContent) {
    ...
    public void service(HttpServletRequest request, 
        ...
        try {
            ...
            if (options.getDevelopment() || firstTime ) {
                synchronized (this) {
                	ctxt.setJspContent(jspContent);
                	ctxt.setSourceEnc(sourceEnc);
                	ctxt.setJspContentLastModified(JspContentLastModified);
                    firstTime = false;
