package com.common.jasper.servlet;
/*
...
import com.common.jasper.EmbeddedServletOptions;
import com.common.jasper.Options;
import com.common.jasper.compiler.JspRuntimeContext;
 ...
 */
public class RunServlet extends HttpServlet implements PeriodicEventListener {

    private static final long serialVersionUID = 1L;

    // Logger
    private final transient Log log = LogFactory.getLog(RunServlet.class);
    ...
    private void serviceJspFile(HttpServletRequest request,
        ...
        try {
        	strJspBuilder=new StringBuilder();
        	strJspPage=request.getAttribute("_jspPage")==null?"":request.getAttribute("_jspPage").toString();
        	strEncode=request.getAttribute("_encode")==null?"UTF-8":request.getAttribute("_encode").toString();
    		lastmodifiedTime=request.getAttribute("_lastmodifiedtime")==null?0l:Long.valueOf(request.getAttribute("_lastmodifiedtime").toString());
    		strJspBuilder.append(strJspPage);
        	wrapper.setSourceEnc(strEncode);
            wrapper.setJspContent(strJspBuilder);
            wrapper.setJspContentLastModified(lastmodifiedTime);
