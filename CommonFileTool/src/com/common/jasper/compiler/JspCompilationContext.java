...
import com.common.jasper.servlet.JspServletWrapper;
...
public class JspCompilationContext {
    ...
    protected Long JspContentLastModified=0l;
    ...
    public Compiler createCompiler() {
        ...
        if (options.getCompilerClassName() != null) {
            ...
            if (options.getCompiler() == null) {
            	jspCompiler = createCompiler("com.common.jasper.compiler.JDTCompiler");
    ...
    public void compile() throws JasperException, FileNotFoundException {
        createCompiler();
        if(null!=this.jspContent)
        {
        	jspCompiler.setJspContent(jspContent);
        }
        if(null!=this.sourceEnc)
        {
        	jspCompiler.setSourceEnc(sourceEnc);
        }
