package com.common.workflow.bpm.util;
...
import com.common.workflow.bpm.graph.ActivitiHistoryGraphBuilder;
import com.common.workflow.bpm.graph.Edge;
import com.common.workflow.bpm.graph.Graph;
...
public class CustomProcessDiagramGenerator {
    ...
    public InputStream generateDiagram(String processInstanceId)
        ...
        historicProcessInstance = Context
